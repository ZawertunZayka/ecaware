...
import ab.eclipse.system.altmanager.AltManagerScreen;
...
public class MainMenuScreen extends Screen
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        String s = "AltManager - " + mc.getSession().getUsername();
        double x = mc.getMainWindow().getScaledWidth() / 2f - IFont.getWidth(IFont.MONTSERRAT_MEDIUM, s, 8) / 2;
        double y = mc.getMainWindow().getScaledHeight() - 20;
        Render2d.drawRoundedRect(x - 4, y - 4, IFont.getWidth(IFont.MONTSERRAT_MEDIUM, s, 8) + 8, IFont.getHeight(IFont.MONTSERRAT_MEDIUM, s, 8) + 8, 3, new Color(23, 22, 22, 255));
        IFont.drawCenteredXY(IFont.MONTSERRAT_MEDIUM, s, (float) (x + IFont.getWidth(IFont.MONTSERRAT_MEDIUM, s, 8) / 2), (float) (y + IFont.getHeight(IFont.MONTSERRAT_MEDIUM, s, 8) / 2), Color.WHITE, 8);
    }

    public static AltManagerScreen altManagerScreen;
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button)
    {
        ...
        double x = mc.getMainWindow().getScaledWidth() / 2f - IFont.getWidth(IFont.MONTSERRAT_MEDIUM, s, 8) / 2;
        double y = mc.getMainWindow().getScaledHeight() - 20;
        if (AutoBuyGui.isHover(x - 4, y - 4, IFont.getWidth(IFont.MONTSERRAT_MEDIUM, s, 8) + 8, IFont.getHeight(IFont.MONTSERRAT_MEDIUM, s, 8) + 8, mouseX, mouseY) && button == GLFW.GLFW_MOUSE_BUTTON_1) {
            if (altManagerScreen == null)
                altManagerScreen = new AltManagerScreen();
            mc.displayGuiScreen(altManagerScreen);
            return false;
        }
